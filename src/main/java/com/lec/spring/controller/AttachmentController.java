...
@RestController // 파일 다운로드, 데이터 response
public class AttachmentController {
    ...
    public ResponseEntity<?> download(Long id){
        ...
        String path = new File(uploadDir, fileName).getAbsolutePath();  // 저장된 파일의 절대 경로
        ...
        try {
            ...
            headers.setContentType(MediaType.parseMediaType(mimeType)); // 유형 지정. 브라우저가 판단할 때 꼭 필요한 정보임
