...
//    }
    ...
    // SecurityFilterChain 를 bean 으로 등록해서 설정
    @Bean
...
//                .httpBasic(Customizer.withDefaults())
                ...
                .csrf(csrf -> csrf.disable())  // CSRF 비황성화
                /**********************************************
                 ...
                 ********************************************/
                .formLogin(form -> form
                                .loginPage("/user/login")   // 인증이 필요한 상황 발생시 매개변수의 url 로 request 발생
