...
-- 샘플 authority
INSERT INTO t5_authority (name)
VALUES ('ROLE_MEMBER'),
       ('ROLE_ADMIN')
;
-- 샘플 사용자
INSERT INTO t5_user (username, password, name, email)
VALUES ('USER1', '$2a$10$.NK7Bl.ic766JFGQ8Es8R..gDFpESy53Af.AdsoGbthYPDhB/0D9W', '회원1', 'user1@mail.com'),
       ('USER2', '$2a$10$5V28q/Dq3X65Rt9FLUCxdeqXCQ8.1RnHPMibKUdVRWwimIWCn1je6', '회원2', 'user2@mail.com'),
       ('ADMIN1', '$2a$10$QGi2ezTDSxauqeU./wpP7.W7jMihIj9c3Eq45mOPcVHgoq713IKHO', '관리자1', 'admin1@mail.com')
...
;
-- 샘플 사용자-권한
INSERT INTO t5_user_authorities
VALUES (1, 1),
       (3, 1),
       (3, 2)
;
...
VALUES (1, 1, '1. user1이 1번글에 댓글 작성.'),
